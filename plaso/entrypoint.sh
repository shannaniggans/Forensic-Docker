...
/bin/sed -in ':a;N;$!ba;s/,]/]/g' /data/test/output-mft.json &&
...
/bin/sed -in ':a;N;$!ba;s/,]/]/g' /data/test/output-winreg.json &&
...
/bin/sed -in ':a;N;$!ba;s/,]/]/g' /data/test/output-win7.json &&
...
/bin/sed -in ':a;N;$!ba;s/,]/]/g' /data/test/output-webhist.json &&
...
/bin/sed -i ':a;N;$!ba;s/,]/]/g' /data/test/output-win_gen.json &&
...
/bin/sed -in ':a;N;$!ba;s/,]/]/g' data/test/output-evtx.json